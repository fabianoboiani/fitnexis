...
import { Bell, CalendarDays, Gauge, LineChart, ScrollText, UserCircle2 } from "lucide-react";
...
const navItems: NavItem[] = [
  { href: "/student", label: "Dashboard", icon: Gauge, hint: "Visão geral" },
  { href: "/student/agenda", label: "Minha Agenda", icon: CalendarDays, hint: "Próximas sessões" },
  { href: "/student/history", label: "Histórico", icon: ScrollText, hint: "Sessões realizadas" },
  { href: "/student/progress", label: "Evolução", icon: LineChart, hint: "Acompanhamento" },
  { href: "/student/notices", label: "Avisos", icon: Bell, hint: "Comunicados" },
  { href: "/student/profile", label: "Perfil", icon: UserCircle2, hint: "Seus dados" }
];
